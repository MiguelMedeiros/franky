...
describe('DialogReportPostReasonStep', () => {
  ...
  it('displays error message when error is present', () => {
    renderWithDialog(<DialogReportPostReasonStep {...defaultProps} error="Something went wrong" />);
...
describe('DialogReportPostReasonStep - Snapshots', () => {
  ...
  it('matches snapshot with error', () => {
    const { container } = renderWithDialog(
      <DialogReportPostReasonStep {...defaultProps} error="Failed to submit report" />,
    );
    expect(container.firstChild).toMatchSnapshot();
  });
});
