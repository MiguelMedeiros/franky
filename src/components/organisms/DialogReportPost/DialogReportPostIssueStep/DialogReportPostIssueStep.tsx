...
import { ISSUE_TYPE_ICONS, ISSUE_TYPE_LIST } from './DialogReportPostIssueStep.constants';
  ...
  return (
    <>
      <Atoms.DialogHeader>
        ...
        <Atoms.DialogDescription className="sr-only">What sort of issue are you reporting?</Atoms.DialogDescription>
      </Atoms.DialogHeader>
