...
vi.mock('./DialogReportPostReasonStep', () => ({
  DialogReportPostReasonStep: ({
    ...
    <div data-testid="dialog-report-post-reason-step" data-issue-type={issueType}>
...
describe('DialogReportPost', () => {
  ...
  const mockGoBackToIssueSelection = vi.fn();
  ...
  const defaultUseReportPostReturn = {
    ...
    goBackToIssueSelection: mockGoBackToIssueSelection,
    submit: mockSubmit,
    reset: mockReset,
  };
  ...
  it('passes issueType to reason step', () => {
    mockUseReportPost.mockReturnValue({
      ...defaultUseReportPostReturn,
      step: REPORT_POST_STEPS.REASON_INPUT,
    ...
    expect(reasonStep).toHaveAttribute('data-issue-type', REPORT_ISSUE_TYPES.HATE_SPEECH);
  });
